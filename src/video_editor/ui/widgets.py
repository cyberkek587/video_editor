...
class VisualTimeline(QWidget):
    ...
    def paintEvent(self, event):
        ...
        for seg in self.segments:
            ...
            painter.setBrush(QBrush(QColor(46, 204, 113)) if seg['type'] == "KEEP" else QBrush(QColor(149, 165, 166)))
    ...
    def mousePressEvent(self, event):
        ...
        self.timeClicked.emit((event.position().x() / self.width()) * self.total_duration)
